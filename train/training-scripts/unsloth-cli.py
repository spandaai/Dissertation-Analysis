...
if __name__ == "__main__":
    ...
    model_group.add_argument('--dataset', type=str, required=True, default="./training-dataset/dataset.json")



    lora_group = parser.add_argument_group("🧠 LoRA Options", "These options are used to configure the LoRA model.")
    lora_group.add_argument('--r', type=int, default=1, help="Rank for Lora model, default is 16.  (common values: 8, 16, 32, 64, 128)")
    ...
    save_group.add_argument('--save_path', type=str, default="./outputs", help="Path to save the model")
